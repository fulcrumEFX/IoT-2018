...
if ($result_1->num_rows >0){
    ...
    echo "<table border=1><tr><th>ID</th><th>Broker</th><th>Topic</th><th>Message</th><th>QOS</th><th>Time_received</th></tr>";
    //jede Reihe daten ausgeben
    while($row= $result_1->fetch_assoc()){
        echo "<tr><td>".$row["ID"]."</td><td>".$row["Broker"]."</td><td>".$row["Topic"]."</td><td>".$row["Message"]."</td><td>".$row["QOS"]."</td><td>".$row["Time_received"]."</td></tr>";
    }
    echo "</table>";
} else{
        echo "0 Results";
